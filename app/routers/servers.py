...
def _parse_server_form(form) -> ServerCreate:
    return ServerCreate(
        ...
        jc=int(form.get("jc") or 11),
        jmin=int(form.get("jmin") or 545),
        jmax=int(form.get("jmax") or 896),
        s1=int(form.get("s1") or 0),
        s2=int(form.get("s2") or 0),
        s3=int(form.get("s3") or 0),
        s4=int(form.get("s4") or 0),
        h1=(form.get("h1") or "2392").strip(),
        h2=(form.get("h2") or "1324").strip(),
        h3=(form.get("h3") or "4123").strip(),
        h4=(form.get("h4") or "1232").strip(),
    )
